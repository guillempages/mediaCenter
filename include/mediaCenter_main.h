...
inline HSM_BasicState::HSM_BasicState(HSM *_hsm, const std::string& _name) :
        HSM_State(_hsm, _name), plugin(NULL) {
}

inline HSM_BasicState::~HSM_BasicState() {
    if (plugin) {
        delete plugin;
    }
}
...
inline HSM_Start::HSM_Start(HSM *_hsm) :
        HSM_State(_hsm, "Start") {
}
...
inline HSM_Quit::HSM_Quit(HSM* _hsm) :
        HSM_State(_hsm, "Quit") {
}
...
inline HSM_Idle::HSM_Idle(HSM *_hsm) :
        HSM_State(_hsm, "Idle") {
}
...
inline HSM_Menu::HSM_Menu(HSM *_hsm) :
        HSM_BasicState(_hsm, "Menu") {
}
...
inline HSM_Music::HSM_Music(HSM *_hsm) :
        HSM_BasicState(_hsm, "Music") {
}
...
inline HSM_DVD::HSM_DVD(HSM *_hsm) :
        HSM_BasicState(_hsm, "DVD") {
}
...
inline HSM_CD::HSM_CD(HSM *_hsm) :
        HSM_BasicState(_hsm, "CD") {
}
...
inline HSM_Movie::HSM_Movie(HSM *_hsm) :
        HSM_BasicState(_hsm, "Movie") {
}
