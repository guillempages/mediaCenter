...
void usage(string progName) {
    cerr << "Usage:" << endl << "  " << progName << "-t type [-p port] [-f file] [-c config_file]"
            << endl;
}
...
std::string MediaCenter_output::getTitle() {
    return "";
}
std::string MediaCenter_output::getArtist() {
    return "";
}

std::string MediaCenter_output::getChannel() {
    return "";
}
std::string MediaCenter_output::setChannel(const std::string & newChannel) {
    return "";
}
std::string MediaCenter_output::channelUp(int step) {
    return "";
}
std::string MediaCenter_output::channelDown(int step) {
    return "";
}
